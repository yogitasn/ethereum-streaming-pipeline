...
# MAGIC %sql SELECT min(block_number), max(block_number) FROM eth_blockchain.infura.ethereum_blocks
# MAGIC
# MAGIC -- min: 23665564, max: 23665764 -- 200
# MAGIC -- min: 23665765, max: 23665849 -- 84
# MAGIC -- min: 23665850 , max: 23672228 -- 6378 (next day execution)
