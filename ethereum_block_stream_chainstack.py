...
dbutils.widgets.text("catalog_name", "soni", "Catalog Name")
dbutils.widgets.text("schema_name", "chainstack2", "Schema Name")
...
ETH_PROVIDER_URI = "https://ethereum-mainnet.core.chainstack.com/2f41b9acf40f221cc7549bd2e9d04bdd"
...
print(f"✅ Connected to Chainstack!")
